...
WINDOWS = [
    ...
    (OPENING_SECONDS + 24.0, OPENING_SECONDS + 41.0),
    (OPENING_SECONDS + 41.0, OPENING_SECONDS + 65.0),
    (OPENING_SECONDS + 65.0, OPENING_SECONDS + 77.0),
    (OPENING_SECONDS + 77.0, OPENING_SECONDS + 92.0),
    (OPENING_SECONDS + 92.0, OPENING_SECONDS + 104.0),
    (OPENING_SECONDS + 104.0, OPENING_SECONDS + 138.0),
    (OPENING_SECONDS + 138.0, OPENING_SECONDS + 155.0),
    (OPENING_SECONDS + 155.0, OPENING_SECONDS + 165.0),
]
MAX_WORDS = 9
